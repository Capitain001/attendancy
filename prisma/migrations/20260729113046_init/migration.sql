-- Extensions requises (PostGIS pour geography, pgcrypto pour gen_random_uuid)
...
-- AddForeignKey
ALTER TABLE "UserFunction" ADD CONSTRAINT "UserFunction_assignedBy_fkey" FOREIGN KEY ("assignedBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
