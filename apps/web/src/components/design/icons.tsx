...
type IconStatus = "loading" | "success";
...
export function SuccessIcon({
  ...
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      ...
      <motion.circle cx="20" cy="20" r="16" fill={fill ?? "transparent"}
        initial={{ opacity: 0 }}
        animate={{ opacity: done ? 1 : 0 }}
        transition={{ duration: 0.25, delay: done ? 0.6 : 0 }}
      />
