//src/components/event-calendar/context/calendar-dnd-context.tsx
"use client";
...
import { EventItem, type ScheduleEvent } from "@/components/event-calendar";
...
type CalendarDndContextType = {
  ...
  /** Lecture seule : les events ne sont pas déplaçables. */
  readOnly: boolean;
};
...
interface CalendarDndProviderProps {
  children: ReactNode;
  onEventUpdate: (event: ScheduleEvent) => void | Promise<boolean | void>;
  readOnly?: boolean;
}
