...
import { createUE, updateUE, reorderProgram, removeUE, getUEs, getProgramUEs, getUEByCode, getUEById } from './database'
...
export type GetUEByIdDto = Awaited<ReturnType<typeof getUEById>>
