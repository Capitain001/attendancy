...
import { createSchedule, updateSchedule, removeSchedule, restoreSchedule, markScheduleCreationNotified, getScheduleForNotify, removeSchedulesByRule, removeNextSchedulesByRule, toggleScheduleLock, getSchedules, getDaySchedules, getClassSchedules, getTeacherSchedules, getRoomSchedules, getSchedulesByClass, getSchedulesByCourse, getScheduleDays, getTeacherNextSchedule, getTodayClassSchedules, assertClassInOrg, getTeacherSchedulesInfo, getCourseLastSchedule } from './database'
...
export type GetCourseLastScheduleDto = Awaited<ReturnType<typeof getCourseLastSchedule>>
