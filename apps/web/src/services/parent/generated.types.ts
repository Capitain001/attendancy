...
import { createParentRelationWithAudit, deleteParentRelationWithAudit, getParentOverview, getParentStudents, searchEligibleParents, getParentUserIdsForStudents } from './database'
...
export type GetParentOverviewDto = Awaited<ReturnType<typeof getParentOverview>>
