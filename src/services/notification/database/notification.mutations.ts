...
// Hard delete — pas de soft delete sur Notification (cycle de vie géré par `read`)
...
export async function checkOrgMembership(userId: string, orgId: string): Promise<boolean> {
